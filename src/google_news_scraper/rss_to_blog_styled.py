...
RSS_FEEDS = {
    ...
    "National ": "https://news.google.com/rss/search?q=national+development&hl=en-US&gl=US&ceid=US:en",
...
<header>
  ...
  <nav>
    ...
    <a href="#national">National Development</a>
...
if __name__ == "__main__":
    ...
    print("[+] Multi-category blog generated successfully")
